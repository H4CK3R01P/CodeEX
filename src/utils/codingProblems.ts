...
The overall run time complexity should be O(log (m+n)).`,
      ...
      testCases: [
        { id: 'tc-1', input: '2\n1 3\n1\n2', expectedOutput: '2.0', isHidden: false, explanation: 'Merged array is [1,2,3]. Middle element is 2' },
        { id: 'tc-2', input: '2\n1 2\n2\n3 4', expectedOutput: '2.5', isHidden: false, explanation: 'Merged array is [1,2,3,4]. Average of middle two elements (2+3)/2 = 2.5' },
        { id: 'tc-3', input: '0\n\n1\n1', expectedOutput: '1.0', isHidden: true, explanation: 'Only one element, so median is 1.0' },
      ],
      codeTemplates: [
        {
          language: 'javascript',
      ...
      testCases: [
        {
          ...
          isHidden: false,
          explanation: 'When user types and waits 300ms, only one API call should be made due to debouncing',
        },
      ],
      codeTemplates: [
        {
