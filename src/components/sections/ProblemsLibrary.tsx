...
export function ProblemsLibrary({ userData }: ProblemsLibraryProps) {
  ...
  }, [searchQuery, selectedDifficulty, selectedTopics, selectedCategories, selectedStatus, sortBy, problems, solvedProblems]);

  // Get all unique topics from problems
  const allTopics = Array.from(new Set(problems.flatMap(p => p.topics)));
  
  // Get all unique categories from problems (NEW)
    ...
    <div className="h-screen flex flex-col bg-background">
      ...
      <div className="border-b border-border bg-card px-6 py-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold gradient-text">Problem Set</h1>
          ...
          <div className="flex items-center gap-4">
            <Card className="border-2 border-primary/20 glow-purple">
        ...
        {/* Active Filters */}
        {(selectedTopics.length > 0 || selectedCategories.length > 0 || selectedDifficulty !== 'all' || selectedStatus !== 'all') && (
