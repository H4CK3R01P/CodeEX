...
export function PracticeDetail({ practice, onBack, userData }: PracticeDetailProps) {
  ...
  // If practice started, show QuestionPractice component
  if (startedPractice) {
    return (
      <QuestionPractice
        ...
        onBack={() => setStartedPractice(false)}
        userData={userData}
      />
    );
  }
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-full lg:w-96 bg-white border-r overflow-y-auto">
          <div className="p-6">
            {/* Chapter Info */}
            <div className="mb-6">
              <h2 className="text-gray-900 mb-3">{practice.title}</h2>
              ...
              <div className="space-y-2 mb-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>{practice.concepts} Concepts in this chapter</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600">
