...
import { CollaborationRoom } from './sections/CollaborationRoom';
...
export function Dashboard({ userData }: DashboardProps) {
  ...
  const navItems = [
    ...
    ...(isCodingDomain ? [
      { id: 'collab' as Section, label: 'Collaborate', icon: <Users className="w-4 h-4" />, gradient: 'from-pink-500 to-rose-500' }
    ] : []),
    ...
    { id: 'social' as Section, label: 'Social', icon: <Users className="w-4 h-4" />, gradient: 'from-rose-500 to-fuchsia-500' },
    { id: 'analytics' as Section, label: 'Analytics', icon: <BarChart3 className="w-4 h-4" />, gradient: 'from-cyan-500 to-blue-500' },
  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case 'daily':
        return <DailyChallenge userData={userData} />;
      case 'collab':
        return <CollaborationRoom userData={userData} />;
      case 'learn':
      ...
      case 'social':
        return <Social userData={userData} />;
      case 'analytics':
        ...
        <div className="px-4 py-3 flex items-center justify-between border-b border-border/30">
          ...
          >
            ...
            <div className="hidden sm:block">
              <h1 className="text-lg gradient-text font-bold">CodeEX</h1>
